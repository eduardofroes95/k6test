...
export function handleSummary(data) {
  ...
  //Verifica como o sistema se comporta com um aumento repentino de usuários
  //Verifica se o sistema se recupera após a carga repentina de usuários sem intervenção manual